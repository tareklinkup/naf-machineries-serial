		...
		<div class="col-md-12">
			<div class="table-responsive" id="reportContent">
				...
				<table 
					class="record-table" 
					style="display:none" 
					v-bind:style="{display: recordType != 'with_details'  && recordType != 'without_details' ? '' : 'none'}"
				>
					<thead>
						<tr>
							<th>Sl</th>
	...
	new Vue({
		...
		methods: {
			getSearchResult(){
				...
				} else if(this.recordType != 'with_details' && this.recordType != 'without_details') {
					url = '/get_service_stock';
				}

				axios.post(url, filter)
				.then(res => {
					if(this.recordType != 'without_details'){
